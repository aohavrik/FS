...
document.write('<hr>');
<<<<<<< HEAD
document.write('<b>Декларація</b> -оголошення перемінної без присвоєння їй значення, наприклад let a1, а данні можна дописати після; константу ініцілізують одразу.');
=======
document.write('<b>Декларація</b> -оголошення перемінної без присвоєння їй значення, наприклад let a1, а данні можна дописати після; .');
>>>>>>> 74d4c6f5edac56d39655c45da7941ee126138357
document.write('<hr>');
